...
features     := "db-" + db + " plugin-js plugin-rhai search-tantivy payment-all tunnel mcp cron-system integration-stream integration-imap kb-qdrant"
features_csv := "db-" + db + ",plugin-js,plugin-rhai,search-tantivy,payment-all,tunnel,mcp,cron-system,integration-stream,integration-imap,kb-qdrant"
