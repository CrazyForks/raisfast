...
pub async fn insert(
    ...
    raisfast_derive::crud_insert!(
        ...
        [
            ...
            "reference_type" => cmd.reference_type.as_deref(),
            "reference_id" => cmd.reference_id.as_deref(),
            "return_url" => cmd.return_url.as_deref(),
            "idempotency_key" => &cmd.idempotency_key,
            "client_ip" => cmd.client_ip.as_deref(),
            "client_language" => cmd.client_language.as_deref(),
