...
pub async fn insert(
    ...
    raisfast_derive::crud_insert!(
        ...
        [
            ...
            "buyer_name" => cmd.buyer_name.as_deref(),
            "buyer_phone" => cmd.buyer_phone.as_deref(),
            "buyer_email" => cmd.buyer_email.as_deref(),
            "shipping_address" => cmd.shipping_address.as_deref(),
            "remark" => cmd.remark.as_deref(),
